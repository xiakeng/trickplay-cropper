...
| Probe HTTP behavior, authorization, and real Kestrel | `TrickplayFrameProbeAuthorizationHttpSpecs.cs`, `TrickplayFrameProbeHttpSpecs.cs`, `TrickplayPreviewKestrelHttpSpecs.cs` (ComponentTests) |
