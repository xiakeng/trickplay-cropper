...
- **Anything unrecognized is skipped.** The run has no opinion about a file it does not
  understand, and no reason to delete one. A tree the plugin shares with a host
