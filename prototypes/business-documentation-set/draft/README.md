...
> **Prototype draft.** This tree is a throwaway draft of what would land as
> `docs/business/`. See [the prototype README](../README.md).
...
Installation, update, and rollback guidance lives in the repository README.
...
Tree — are defined in the repository's `CONTEXT.md`, together with the synonyms this
documentation deliberately avoids.
